...
using MSSAJobBoard_w_Login;

namespace MSSAJobBoard_w_Login.Controllers
{
    public class RecruitersController : Controller
    {
        private MSSASqlJobDbEntities db = new MSSASqlJobDbEntities();
        ...
        public async Task<ActionResult> Details(int? id)
        {
            if (id == null)
            {
                // return first recruiter item if value not passed. Better than a bad request page I feel.
                id = 1;
